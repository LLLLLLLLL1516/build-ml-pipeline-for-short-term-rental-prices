...
def go(args):
    ...
    X['host_name'] = X['host_name'].astype(str)
    X['neighbourhood_group'] = X['neighbourhood_group'].astype(str)
    X['neighbourhood'] = X['neighbourhood'].astype(str)
    X['last_review'] = X['last_review'].astype(str)
    ...
    print(X_train[processed_features].isnull().sum())
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    zero_imputer = SimpleImputer(strategy="constant", fill_value=0.01)
